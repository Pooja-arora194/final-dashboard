...
export default class Replenish_Soon extends PureComponent {
  static demoUrl = "https://codesandbox.io/s/simple-line-chart-kec3v";

  constructor(props) {
    super(props);
    this.props.setHeading('Replenish Soon')
  }
  render() {
    return (
      <>
        ...
        {/* <Grid container > */}
            {/* <Grid item xs={12} sm={12} >
                <Card sx={{ width: { xs: 300, sm: 1500 } }}> */}
            
                <AreaChart className='replenishsoonchart'
                      width={1500}
                      height={400}
                      data={data}
                      margin={{
